...
``` json
{
    "welcome": "Welcome back, %1! You have %2 new messages."
}
```

``` html
<p>[[myplugin:welcome, {username}, {messageCount}]]</p>
```
...
hand — a parameter that itself contains a `,` or a `%` will break the surrounding
